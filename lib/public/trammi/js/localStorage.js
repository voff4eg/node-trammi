YUI.add('local-storage', function (Y) {
    'use strict';

    Y.LocalStorageSync = function (key) {
        ...
        data = Y.JSON.parse((localStorage &&
        ...
        // specified then it loads an array of all models. This allows the same
        // sync layer to be used for both the TodoModel and TodoList classes.
        function get(id) {
        ...
        return function (action, options, callback) {
            // `this` refers to the Model or ModelList instance to which this
            // sync method is attached.
