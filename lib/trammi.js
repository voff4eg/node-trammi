...
var request = require("request"),
    ...
    cache = require("./cache"),
    lines = require('./trammiDBLines').lines,
    stopsAC = require('./trammiDBStops').stops;
...
function startServer(port, directory) {
    var express = require('express'),
        dnode = require('dnode'),
        p = port || 8081,
        d = directory || __dirname + '/public',
        server;

    console.log("Starting the server on", __dirname + "/public", "and", d);
    ...
    dnode(function (client) {
        ...
        this.getStops = function (query, cb) {
            var cacheKey = "queryCache#" + query,
        ...
        this.getTimetable = function (lineName, stopNumber, cb) {
            var cacheKey = "stopCache#" + lineName + "/" + stopNumber,
                timetable;
